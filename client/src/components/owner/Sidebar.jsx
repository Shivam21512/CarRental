  ...
  return (
    ...
    max-w-13 md:max-w-60 w-full border-r border-borderColor text-sm'>
        ...
        <div className='group relative'>
            <label htmlFor='image'>
                <img src={image ? URL.createObjectURL(image) : user?.image ||
                    ...
                    alt='' className='h-9 md:h-14 w-9 md:w-14 rounded-full mx-auto'></img>
                ...
                justify-center cursor-pointer'>
                    <img src={assets.edit_icon} alt=''></img>
        ...
        {image && (
            ...
            alt='' onClick={updateImage}></img></button>
        )}
        ...
        <div className='w-full'>
            {ownerMenuLinks.map((link, index) => (
                ...
                items-center gap-2 w-full py-3 pl-3 first:mt-6 ${link.path === location.
                pathname ? 'bg-primary/10 text-primary' : 'text-gray-600'
                }`}>
                    <img src={link.path === location.pathname ? link.coloredIcon : link.icon} alt='car-icon'></img>
