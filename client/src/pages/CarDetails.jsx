  ...
  return car ? (
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-16'>
      ...
      text-gray-500 cursor-pointer'>
        <img src={assets.arrow_icon} alt='' className='rotate-180 opacity-65'></img>
        Back to all cars
      </button>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
        ...
        className='lg:col-span-2'>
          ...
          object-cover rounded-xl mb-6 shadow-md'></motion.img> 
          ...
          >
            ...
            <div className='grid grid-cols-2 sm:grid-cols-4 gap-4'>
              {[
                ...
                p-4 rounded-lg'>
                  <img src={icon} alt='' className='h-5 mb-2'></img>
                  {text}
                ...
                <ul className='grid grid-cols-1 sm:grid-cols-2 gap-2'>
                  {
                    ...
                    "Rear View Mirror"].map((item) => (
                      <li key={item} className='flex items-center text-gray-500'>
                        <img src={assets.check_icon} alt='' className='h-4 mr-2'></img>
                        {item}
        ...
        text-gray-500'>
          ...
          <div className='flex flex-col gap-2'>
            ...
            type='date' className='border border-borderColor px-3 py-2
            rounded-lg' required id='return-date' min={new Date().toISOString().
              split('T')[0]}></input>
          </div>
