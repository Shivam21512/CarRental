  ...
  useEffect(() => {
   ...
   return (
    ...
    <div className='flex flex-col items-center py-20 bg-light max-md:px-4'>
      ...
      vechicles available for your next adventure'></Title>

      <div className='flex items-center bg-white px-4 mt-6 max-w-140 w-full h-12
      rounded-full shadow'>
        <img src={assets.search_icon} alt='' className='w-4.5 h-4.5 mr-2'></img>

        <input onChange={(e) => setInput(e.target.value)} value={input} type="text"
        placeholder='Search by make, model, or features' className='w-full h-full
        outline-none text-gray-500'></input>

        <img src={assets.filter_icon} alt='' className='w-4.5 h-4.5 ml-2'></img>

      </div>

    </div>

    <div className='px-6 md:px-16 lg:p x-24 xl:px-32 mt-10'>
