      ...
      text-sm mt-6 max-w-xl'>
        ...
        <div className='flex items-center  gap-2 w-full'>
          <label htmlFor='car-image'>
            ...
            alt='' className='h-14 rounded cursor-pointer'></img>
            <input type='file' id='car-image' accept='image/*' hidden onChange={e=> setImage(e.target.files[0])}></input>
          </label>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
          <div className='flex flex-col w-full'>
            <label>Brand</label>
            <input type='text' placeholder='e.g. Rolls Royce, Scorpio, BMW...' required
          ...
          <div className='flex flex-col w-full'>
            <label>Model</label>
            <input type='text' placeholder='e.g. X5 , ghost, z-class...' required
            className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'
