...
const Dashboard = () => {
  ...
  return (
    <div className='px-4 pt-10 md:px-10 flex-1'>
      ...
      including total car, bookings, revenue, and recent activities"/>
          ...
          {data.recentBookings.map((booking, index) => (
            <div key={index} className='mt-4 flex items-center justify-between'>
              ...
              <div className='flex items-center gap-2'>
                ...
                <div className='hidden md:flex items-center justify-between w-12
                h-12 rounded-full bg-primary/10'>
                  <img src={assets.listIconColored} alt='' className='h-5 w-5'></img>
                </div>
