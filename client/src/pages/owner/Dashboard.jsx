  ...
  return (
    <div className="px-4 pt-10 md:px-10 flex-1">
      <Title
        ...
        subTitle="Monitor overall platform performance including total car, bookings, revenue, and recent activities"
      />
            ...
            booking.car ? (
              <div key={index} className="mt-4 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <div className="hidden md:flex items-center justify-between w-12 h-12 rounded-full bg-primary/10">
              ...
              <div key={index} className="mt-4 text-sm text-gray-400 italic">
                Booking info incomplete
              </div>
            )
          ))}
        </div>
